...
class $AssetsAnimGen {
  ...
  /// File path: assets/anim/no_internet_available.json
  String get noInternetAvailable => 'assets/anim/no_internet_available.json';
...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/leading_back_icon.svg
  String get leadingBackIcon => 'assets/svg/leading_back_icon.svg';

  /// List of all assets
  List<String> get values => [close, leadingBackIcon];
}
